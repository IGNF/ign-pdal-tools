...
COPY --from=mamba_pdal /opt/conda/envs/pdaltools/bin/las2las64 /opt/conda/envs/pdaltools/bin/las2las
COPY --from=mamba_pdal /opt/conda/envs/pdaltools/bin/lasinfo64 /opt/conda/envs/pdaltools/bin/lasinfo
